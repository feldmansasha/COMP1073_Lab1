...
var insertZ=['spontaneously compbusted', 'rapidly sublimated', 'evaporated instantly'];
// FUNCTIONS
...
function result() {
    ...
    newStory=newStory.replace(':insertx:', xItem); // we have 2 insertx in the story, that's we yse replace function 2 times
    ...
    if (document.getElementById("metric").checked) {
        ...
        var weight=Math.round(300*0.453592, 2) + " kgs";
        ...
        var temp=Math.round((94-32)*5/9, 2)+"°C";
